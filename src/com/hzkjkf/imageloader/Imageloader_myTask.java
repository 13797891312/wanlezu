...
public class Imageloader_myTask {
	private static Imageloader_myTask imageloader;
	private ImageCache imageCache = new ImageCache(5 * 1024 * 1024);
	Bitmap result;

	private Imageloader_myTask() {
	}

	public static Imageloader_myTask getInstence() {
		if (imageloader == null) {
			imageloader = new Imageloader_myTask();
		}
		return imageloader;
	}
